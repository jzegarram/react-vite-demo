...
function useReducerReturnValueHandler(state, value, options, optionComparer, setValueState, onValueChange, onHighlightChange) {
  const valueRef = React11.useRef(value);
  valueRef.current = value;
  const onValueChangeRef = React11.useRef(onValueChange);
  React11.useEffect(() => {
    onValueChangeRef.current = onValueChange;
  }, [onValueChange]);
  const onHighlightChangeRef = React11.useRef(onHighlightChange);
  React11.useEffect(() => {
...
function useControllableReducer(internalReducer, externalReducer, props) {
  ...
  const previousValueRef = React11.useRef(null);
  const [state, dispatch] = React11.useReducer(externalReducer != null ? externalReducer : internalReducer, {
    highlightedValue: null,
    selectedValue: value
  });
  const optionComparerRef = React11.useRef(optionComparer);
...
function useListbox(props) {
  ...
  const highlightedIndex = React12.useMemo(() => {
    return highlightedValue == null ? -1 : options.findIndex((option) => optionComparer(option, highlightedValue));
  }, [highlightedValue, options, optionComparer]);
  const previousOptions = React12.useRef([]);
  React12.useEffect(() => {
  ...
  const setSelectedValue = React12.useCallback((option) => {
    dispatch({
      type: ActionTypes.setValue,
      value: option
    });
  }, [dispatch]);
  const setHighlightedValue = React12.useCallback((option) => {
    dispatch({
...
var Portal = React15.forwardRef(function Portal2(props, ref) {
  ...
  const handleRef = useForkRef(React15.isValidElement(children) ? children.ref : null, ref);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var PopperTooltip = React16.forwardRef(function PopperTooltip2(props, ref) {
  const {
    anchorEl,
    children,
    direction,
...
var PopperUnstyled = React16.forwardRef(function PopperUnstyled2(props, ref) {
  const {
    anchorEl,
    children,
...
var MenuUnstyled = React17.forwardRef(function MenuUnstyled2(props, forwardedRef) {
...
function useMenuItem(props) {
  ...
  const id = useId();
  const menuContext = React18.useContext(MenuUnstyledContext_default);
  ...
  const [focusRequested, requestFocus] = React18.useState(false);
  const focusIfRequested = React18.useCallback(() => {
...
var MenuItemUnstyled = React19.forwardRef(function MenuItemUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    disabled: disabledProp = false,
...
true ? ModalUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types11.default.shape({
    backdrop: import_prop_types11.default.object,
...
var MultiSelectUnstyled = React25.forwardRef(function MultiSelectUnstyled2(props, ref) {
...
var SelectUnstyled = React29.forwardRef(function SelectUnstyled2(props, ref) {
  ...
  const selectedOptions = React29.useMemo(() => {
...
function SliderValueLabelUnstyled(props) {
  ...
  }, (0, import_jsx_runtime24.jsxs)(React30.Fragment, {
...
var SliderUnstyled = React32.forwardRef(function SliderUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime25.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime25.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime25.jsx)(React32.Fragment, {
...
var SwitchUnstyled = React34.forwardRef(function SwitchUnstyled2(props, ref) {
...
var Context = React36.createContext(null);
if (true) {
  Context.displayName = "TabsContext";
}
function useTabContext() {
  return React36.useContext(Context);
}
...
var TabsUnstyled = React37.forwardRef((props, ref) => {
...
var TabPanelUnstyled = React38.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref, _componentsProps$root;
  const {
    children,
    className,
...
var useTabsList = (parameters) => {
  ...
  const tabsListRef = React39.createRef();
  ...
  const processChildren = React39.useCallback(() => {
    const valueToIndex = /* @__PURE__ */ new Map();
    let childIndex = 0;
    const processedChildren = React39.Children.map(children, (child) => {
      ...
      childIndex += 1;
      return React39.cloneElement(child, _extends({
        value: childValue
...
var TabsListUnstyled = React40.forwardRef((props, ref) => {
  var _ref, _componentsProps$root;
  const {
    className,
    component,
...
var TabUnstyled = React41.forwardRef(function TabUnstyled2(props, ref) {
  var _ref, _componentsProps$root;
  const {
    action,
    children,
...
var TextareaAutosize = React42.forwardRef(function TextareaAutosize2(props, ref) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const shadowRef = React42.useRef(null);
  const renders = React42.useRef(0);
  const [state, setState] = React42.useState({});
  const getUpdatedState = React42.useCallback(() => {
...
var useInsertionEffect2 = React43["useInsertionEffect"] ? React43["useInsertionEffect"] : function useInsertionEffect3(create) {
  create();
};
...
var useInsertionEffect5 = React44["useInsertionEffect"] ? React44["useInsertionEffect"] : import_react5.useLayoutEffect;
...
var useInsertionEffect7 = React45["useInsertionEffect"] ? React45["useInsertionEffect"] : function useInsertionEffect8(create) {
  create();
};
...
true ? StyledEngineProvider.propTypes = {
  ...
  injectFirst: import_prop_types25.default.bool
} : void 0;
...
true ? GlobalStyles.propTypes = {
  ...
  styles: import_prop_types26.default.oneOfType([import_prop_types26.default.string, import_prop_types26.default.object, import_prop_types26.default.func])
} : void 0;
...
var responsivePropType = true ? import_prop_types27.default.oneOfType([import_prop_types27.default.number, import_prop_types27.default.string, import_prop_types27.default.object, import_prop_types27.default.array]) : {};
...
var ThemeContext2 = React48.createContext(null);
if (true) {
...
function useTheme2() {
  const theme = React49.useContext(ThemeContext_default);
  if (true) {
    React49.useDebugValue(theme);
  }
  return theme;
}
...
function createBox(options = {}) {
  ...
  const Box2 = React51.forwardRef(function Box3(inProps, ref) {
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-XYG2MSNH.js.map
